class Case:
    ...
    def __init__(self):
        ...
        self._objets = []
        #La liste des meubles sur la case
        self._meubles = []
    ...
    def afficherLigne2(self):
        ...
        if self.estDecouvert():
            ...
            elif len(self._meubles) > 0:
                print(" 8 ", end="") #Il y a un meuble
    ...
    def ajouterMeuble(self, meuble):
        """ Ajoute le personnage sur la case
        :param personnage: Un personnage
        :return: rien
        """
        self._meubles.append(meuble)
