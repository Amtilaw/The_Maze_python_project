...
class Labyrinthe:
    ...
    def deposerMeubleAleatoirement(self, meuble):
        """ Dépose le meuble passé en paramètre sur une case du labyrinthe choisie aléatoirement. """
        case = random.choice(self.cases)
        case.ajouterMeuble(meuble)
